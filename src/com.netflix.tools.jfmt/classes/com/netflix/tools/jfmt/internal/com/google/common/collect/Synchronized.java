      ...
      synchronized (mutex) {
        return map(
            Maps.transformValues(
                delegate().rowMap(),
                new com.netflix.tools.jfmt.internal.com.google.common.base.Function<Map<C, V>, Map<C, V>>() {
                  @Override
    ...
    public Map<C, Map<R, V>> columnMap() {
      synchronized (mutex) {
        return map(
            Maps.transformValues(
                delegate().columnMap(),
                new com.netflix.tools.jfmt.internal.com.google.common.base.Function<Map<R, V>, Map<R, V>>() {
                  @Override
